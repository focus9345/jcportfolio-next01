...
export const PROJECT_ITEMS: WorkItem[] = [
    ...
    },
    {
        ...
        image: Placeholder,
        icon: <FaDesktop className="text-2xl" />,
        detail: 'Wordpress website with custom created theme to highlight the resources avalabie to parents to help expose young children to resources to aid in their development, the logo and brand was also developed by me. Visit here: https://www.vecrc.org/ ',
        type: ProjectStack.WEB,
        stack: ['vsCode', 'wordpress', 'html', 'css', 'js', 'mySQL', 'adobeIllustrator'],
    ...
    },
    {
        ...
        icon: <FaDesktop className="text-2xl" />,
        detail: 'This is the next generation portfolio website, the prior website was created using vue and archived on github. My refactoring to react was to impliment a react based portfolio and add new features that would allow my to easily add new projects as they became examples to show.',
        type: ProjectStack.WEB,
    ...
    },
    {
        ...
        image: WebBuild,
        icon: <FaDesktop className="text-2xl" />,
        detail: 'During the time span of 2009 to 2016, I developed a custom boilerplate for a propriatory web CMS which decreased development time to the point where over 250 custom websites were devivered to clients by a small development team of three people in one year. The boilerplate had SEO benifits and many features like image galleries, carousels and other features.',
        type: ProjectStack.WEB,
